...
function AboutSection() {
  return (
    <div className = 'flex flex-col pb-10'>
      <div className = "text-center p-8"><strong>The Concert Hall: </strong> The main concert hall features a “vineyard” seating pattern with the performers in the center and the audience in the same area.</div>
    ...
    <div className = 'flex flex-row p-10'>
      ...
      <div className = 'p-10 flex-col'>
        <div className = 'mb-6 text-2xl 'id='close'>
        ...
        <div>
        This building is located in an urban context, and is surrounded by mostly concrete and other buildings. It contributes green space with its gardens, making good use of the leftover space on the block. Additionally it’s unique architecture helps bring attention to the area, but it's design prevents it from overpowering the surrounding buildings.
        </div>
        </div>
      </div>
    </div>
    <div className = 'px-20 py-10 text-4xl' id='drawings' >Architectural Drawings</div>
    ...
    <div className = 'flex flex-row px-20'>
      <img className = 'w-1/2 p-10' src = {Drawing}></img>
      <div className='p-10'>
        <div className='text-xl mb-10'> My Drawing</div>
        <div>In my drawing, I attempted to capture the scale and fluidity of the Walt Disney Concert Center. I made sure to emphasize the curves and the almost looming nature of the pieces of this structure.</div>
      </div>
    </div>
      <div className = 'px-20 py-10 text-4xl' id='publications'>Publications</div>
